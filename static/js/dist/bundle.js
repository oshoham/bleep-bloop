...
/***/ function(module, exports) {
	...
	var Coder = function () {
	  function Coder() {
	    ...
	    var _ref$freqMin = _ref.freqMin;
	    var freqMin = _ref$freqMin === undefined ? 18500 : _ref$freqMin;
	    var _ref$freqMax = _ref.freqMax;
	    var freqMax = _ref$freqMax === undefined ? 19500 : _ref$freqMax;
	    var _ref$freqError = _ref.freqError;
	    var freqError = _ref$freqError === undefined ? 50 : _ref$freqError;
	    var _ref$alphabet = _ref.alphabet;
	    var alphabet = _ref$alphabet === undefined ? ALPHABET : _ref$alphabet;
	  ...
	  _createClass(Coder, [{
	    key: 'encode',
	    value: function encode(character) {
	    ...
	    key: 'decode',
	    value: function decode(frequency) {
...
/***/ function(module, exports) {
	...
	var getUserMedia = navigator.mediaDevices.getUserMedia || promisifiedOldGUM;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _sender = __webpack_require__(94);
	...
	exports.default = _react2.default.createClass({
	  ...
	  componentDidMount: function componentDidMount() {
	    ...
	    this.sender = new _sender2.default(params);
	    this.listener = new _listener2.default(params);
	    this.listener.on('message', function (message) {
	      _this.setState({
	        messages: _this.state.messages.concat([{ message: message, sent: false }])
	      });
	    });
	    this.listener.start();
	  },
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'form',
	        { className: 'chat__new-message', onSubmit: this.handleFormSubmit },
	        _react2.default.createElement('input', { className: 'chat__new-message__input', type: 'text', placeholder: 'Type a message...', value: this.state.inputValue, onChange: this.handleInputChange }),
	        _react2.default.createElement(
	          'button',
	          { className: 'chat__new-message__send', type: 'submit' },
	          'Send'
	        )
	      )
	    );
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.e = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_chat2.default, null), document.getElementById('content'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _coder = __webpack_require__(52);

	var _coder2 = _interopRequireDefault(_coder);

	var _ringBuffer = __webpack_require__(93);
	...
	var Listener = function () {
	  function Listener() {
	    ...
	    var _ref$peakThreshold = _ref.peakThreshold;
	    var peakThreshold = _ref$peakThreshold === undefined ? -65 : _ref$peakThreshold;
	    var _ref$minRunLength = _ref.minRunLength;
	    var minRunLength = _ref$minRunLength === undefined ? 2 : _ref$minRunLength;
	    var _ref$timeout = _ref.timeout;
	    var timeout = _ref$timeout === undefined ? 300 : _ref$timeout;
	    var _ref$freqMin = _ref.freqMin;
	    var freqMin = _ref$freqMin === undefined ? 18500 : _ref$freqMin;
	    var _ref$freqMax = _ref.freqMax;
	    var freqMax = _ref$freqMax === undefined ? 19500 : _ref$freqMax;
	    ...
	    this.coder = new _coder2.default({ freqMin: freqMin, freqMax: freqMax, freqError: freqError });
	    ...
	    // buffers
	    this.peakHistory = new _ringBuffer2.default(16);
	    this.peakTimes = new _ringBuffer2.default(16);
	    this.message = '';
	  ...
	  _createClass(Listener, [{
	    ...
	    value: function start() {
	      ...
	      (0, _utils.getUserMedia)({ audio: true }).then(function (stream) {
	        ...
	        _this.analyser.fftSize = 8192; // higher FFT size improves frequency resolution

	        // reference: https://stackoverflow.com/questions/15627013/how-do-i-configure-a-bandpass-filter
	        _this.bandpassFilter = _this.audioContext.createBiquadFilter();
	        _this.bandpassFilter.type = 'bandpass';
	        var freqCenter = (_this.coder.freqMin + _this.coder.freqMax) / 2;
	        _this.bandpassFilter.frequency.value = freqCenter;
	        _this.bandpassFilter.Q.value = 0.1; //freqCenter / (this.coder.freqMax - this.coder.freqMin);

	        _this.microphone.connect(_this.bandpassFilter);
	        _this.bandpassFilter.connect(_this.analyser);

	        _this.frequencies = new Float32Array(_this.analyser.frequencyBinCount);
	        _this.isListening = true;

	        _this.loop = (0, _utils.requestAnimationFrame)(_this.listen.bind(_this));
	      });
	    }
	  }, {
	    key: 'stop',
	    value: function stop() {
	      (0, _utils.cancelAnimationFrame)(this.loop);
	      this.isListening = false;
	      this.microphone = null;
	      this.bandpassFilter = null;
	      this.analyser = null;
	    ...
	    value: function listen() {
	      ...
	      if (this.isListening) {
	        this.loop = (0, _utils.requestAnimationFrame)(this.listen.bind(this));
	      }
	    }
	  }, {
	    key: 'on',
	    ...
	    key: 'getPeakFrequency',
	    value: function getPeakFrequency() {
	    ...
	    key: 'findAndRemoveRun',
	    value: function findAndRemoveRun() {
	...
	exports.default = _react2.default.createClass({
	  ...
	  propTypes: {
	    messages: _react2.default.PropTypes.arrayOf(_react2.default.PropTypes.shape({
	      ...
	      sent: _react2.default.PropTypes.bool
	    })).isRequired
	  },

	  render: function render() {
	    var list = this.props.messages.map(function (_ref, i) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Sender = function () {
	  function Sender() {
	    ...
	    var _ref$charDuration = _ref.charDuration;
	    var charDuration = _ref$charDuration === undefined ? 0.2 : _ref$charDuration;
	    var _ref$rampDuration = _ref.rampDuration;
	    var rampDuration = _ref$rampDuration === undefined ? 0.001 : _ref$rampDuration;
	    var _ref$freqMin = _ref.freqMin;
	    var freqMin = _ref$freqMin === undefined ? 18500 : _ref$freqMin;
	    var _ref$freqMax = _ref.freqMax;
	    var freqMax = _ref$freqMax === undefined ? 19500 : _ref$freqMax;
	  ...
	  _createClass(Sender, [{
	    ...
	    value: function send(input) {
	      ...
	      paddedChars.forEach(function (character, i) {
	        var frequency = _this.coder.encode(character);
	        var time = _this.audioContext.currentTime + _this.charDuration * i;
	        _this.scheduleToneAt(frequency, time, _this.charDuration);
	      });
	    }
	  }, {
	    key: 'padDuplicates',
	    value: function padDuplicates(characters) {
	      var _this2 = this;
	      ...
	      characters.forEach(function (character) {
	        if (character === prevChar) {
	          paddedChars.push(_this2.coder.separator);
	        }
	    ...
	    key: 'scheduleToneAt',
	    value: function scheduleToneAt(frequency, startTime, duration) {
